...
APIDefs["C_Map.ClearUserWaypoint"] = {
    ...
    category = "map",
    subcategory = "c_map",
    func = _G["C_Map"] and _G["C_Map"]["ClearUserWaypoint"],
...
APIDefs["C_Map.CloseWorldMapInteraction"] = {
    ...
    category = "map",
    subcategory = "c_map",
    func = _G["C_Map"] and _G["C_Map"]["CloseWorldMapInteraction"],
...
APIDefs["C_Map.GetFallbackWorldMapID"] = {
    ...
    category = "map",
    subcategory = "c_map",
    func = _G["C_Map"] and _G["C_Map"]["GetFallbackWorldMapID"],
...
APIDefs["C_Map.GetUserWaypoint"] = {
    ...
    category = "map",
    subcategory = "c_map",
    func = _G["C_Map"] and _G["C_Map"]["GetUserWaypoint"],
...
APIDefs["C_Map.GetUserWaypointHyperlink"] = {
    ...
    category = "map",
    subcategory = "c_map",
    func = _G["C_Map"] and _G["C_Map"]["GetUserWaypointHyperlink"],
...
APIDefs["C_Map.HasUserWaypoint"] = {
    ...
    category = "map",
    subcategory = "c_map",
    func = _G["C_Map"] and _G["C_Map"]["HasUserWaypoint"],
