...
APIDefs["C_UIWidgetManager.GetBelowMinimapWidgetSetID"] = {
    ...
    category = "ui",
    subcategory = "c_uiwidgetmanager",
    func = _G["C_UIWidgetManager"] and _G["C_UIWidgetManager"]["GetBelowMinimapWidgetSetID"],
...
APIDefs["C_UIWidgetManager.GetObjectiveTrackerWidgetSetID"] = {
    ...
    category = "ui",
    subcategory = "c_uiwidgetmanager",
    func = _G["C_UIWidgetManager"] and _G["C_UIWidgetManager"]["GetObjectiveTrackerWidgetSetID"],
...
APIDefs["C_UIWidgetManager.GetPowerBarWidgetSetID"] = {
    ...
    category = "ui",
    subcategory = "c_uiwidgetmanager",
    func = _G["C_UIWidgetManager"] and _G["C_UIWidgetManager"]["GetPowerBarWidgetSetID"],
...
APIDefs["C_UIWidgetManager.GetScenarioHeaderCurrenciesAndBackgroundWidgetVisualizationInfo"] = {
    ...
    category = "combat_midnight",
    subcategory = "c_uiwidgetmanager",
    func = _G["C_UIWidgetManager"] and _G["C_UIWidgetManager"]["GetScenarioHeaderCurrenciesAndBackgroundWidgetVisualizationInfo"],
...
APIDefs["C_UIWidgetManager.GetTopCenterWidgetSetID"] = {
    ...
    category = "ui",
    subcategory = "c_uiwidgetmanager",
    func = _G["C_UIWidgetManager"] and _G["C_UIWidgetManager"]["GetTopCenterWidgetSetID"],
