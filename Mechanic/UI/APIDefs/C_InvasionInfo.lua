...
APIDefs["C_InvasionInfo.AreInvasionsAvailable"] = {
    key = "C_InvasionInfo.AreInvasionsAvailable",
    name = "AreInvasionsAvailable",
    category = "general",
    subcategory = "c_invasioninfo",
    func = _G["C_InvasionInfo"] and _G["C_InvasionInfo"]["AreInvasionsAvailable"],
    funcPath = "C_InvasionInfo.AreInvasionsAvailable",
    params = {  },
    returns = { { name = "areInvasionsAvailable", type = "bool", canBeSecret = false } },
