...
APIDefs["C_CooldownViewer.GetCooldownViewerCategorySet"] = {
    ...
    params = { { name = "category", type = "CooldownViewerCategory", default = nil }, { name = "allowUnlearned", type = "bool", default = false } },
...
APIDefs["C_CooldownViewer.GetLayoutData"] = {
    key = "C_CooldownViewer.GetLayoutData",
    name = "GetLayoutData",
    category = "spell",
    subcategory = "c_cooldownviewer",
    func = _G["C_CooldownViewer"] and _G["C_CooldownViewer"]["GetLayoutData"],
    funcPath = "C_CooldownViewer.GetLayoutData",
    params = {  },
    returns = { { name = "data", type = "cstring", canBeSecret = false } },
...
APIDefs["C_CooldownViewer.IsCooldownViewerAvailable"] = {
    key = "C_CooldownViewer.IsCooldownViewerAvailable",
    name = "IsCooldownViewerAvailable",
    category = "spell",
    subcategory = "c_cooldownviewer",
    func = _G["C_CooldownViewer"] and _G["C_CooldownViewer"]["IsCooldownViewerAvailable"],
    funcPath = "C_CooldownViewer.IsCooldownViewerAvailable",
    params = {  },
