...
APIDefs["C_StorePublic.EventStoreUISetShown"] = {
    ...
    params = { { name = "newShown", type = "bool", default = nil }, { name = "contextKey", type = "string", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_StorePublic.IsEnabled"] = {
    key = "C_StorePublic.IsEnabled",
    name = "IsEnabled",
    category = "general",
    subcategory = "c_storepublic",
    func = _G["C_StorePublic"] and _G["C_StorePublic"]["IsEnabled"],
    funcPath = "C_StorePublic.IsEnabled",
    params = {  },
