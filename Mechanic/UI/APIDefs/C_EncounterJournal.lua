...
APIDefs["C_EncounterJournal.GetEncounterJournalLink"] = {
    ...
    params = { { name = "linkType", type = "JournalLinkTypes", default = nil }, { name = "ID", type = "number", default = nil }, { name = "displayText", type = "string", default = nil }, { name = "difficultyID", type = "number", default = nil } },
...
APIDefs["C_EncounterJournal.GetLootInfoByIndex"] = {
    ...
    params = { { name = "index", type = "luaIndex", default = nil }, { name = "encounterIndex", type = "luaIndex", default = nil } },
    returns = { { name = "itemInfo", type = "EncounterJournalItemInfo", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_EncounterJournal.GetSlotFilter"] = {
    key = "C_EncounterJournal.GetSlotFilter",
    name = "GetSlotFilter",
    category = "general",
    subcategory = "c_encounterjournal",
    func = _G["C_EncounterJournal"] and _G["C_EncounterJournal"]["GetSlotFilter"],
    funcPath = "C_EncounterJournal.GetSlotFilter",
    params = {  },
    returns = { { name = "filter", type = "ItemSlotFilterType", canBeSecret = false } },
    midnightImpact = "NORMAL",
}

APIDefs["C_EncounterJournal.InitalizeSelectedTier"] = {
    key = "C_EncounterJournal.InitalizeSelectedTier",
    name = "InitalizeSelectedTier",
    category = "general",
    subcategory = "c_encounterjournal",
    func = _G["C_EncounterJournal"] and _G["C_EncounterJournal"]["InitalizeSelectedTier"],
    funcPath = "C_EncounterJournal.InitalizeSelectedTier",
    params = {  },
    returns = {  },
    midnightImpact = "NORMAL",
}
...
APIDefs["C_EncounterJournal.OnClose"] = {
    key = "C_EncounterJournal.OnClose",
    name = "OnClose",
    category = "general",
    subcategory = "c_encounterjournal",
    func = _G["C_EncounterJournal"] and _G["C_EncounterJournal"]["OnClose"],
    funcPath = "C_EncounterJournal.OnClose",
    params = {  },
    returns = {  },
    midnightImpact = "NORMAL",
}

APIDefs["C_EncounterJournal.OnOpen"] = {
    key = "C_EncounterJournal.OnOpen",
    name = "OnOpen",
    category = "general",
    subcategory = "c_encounterjournal",
    func = _G["C_EncounterJournal"] and _G["C_EncounterJournal"]["OnOpen"],
    funcPath = "C_EncounterJournal.OnOpen",
    params = {  },
    returns = {  },
    midnightImpact = "NORMAL",
}

APIDefs["C_EncounterJournal.ResetSlotFilter"] = {
    key = "C_EncounterJournal.ResetSlotFilter",
    name = "ResetSlotFilter",
    category = "general",
    subcategory = "c_encounterjournal",
    func = _G["C_EncounterJournal"] and _G["C_EncounterJournal"]["ResetSlotFilter"],
    funcPath = "C_EncounterJournal.ResetSlotFilter",
    params = {  },
    returns = {  },
    midnightImpact = "NORMAL",
}
...
APIDefs["C_EncounterJournal.SetTab"] = {
    ...
    params = { { name = "tabIdx", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_EncounterJournal.StartArathiRPE"] = {
    key = "C_EncounterJournal.StartArathiRPE",
    name = "StartArathiRPE",
    category = "general",
    subcategory = "c_encounterjournal",
    func = _G["C_EncounterJournal"] and _G["C_EncounterJournal"]["StartArathiRPE"],
    funcPath = "C_EncounterJournal.StartArathiRPE",
    params = {  },
    returns = {  },
    midnightImpact = "NORMAL",
}
