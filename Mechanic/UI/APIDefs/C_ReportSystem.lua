...
APIDefs["C_ReportSystem.ReportServerLag"] = {
    ...
    category = "general",
    subcategory = "c_reportsystem",
    func = _G["C_ReportSystem"] and _G["C_ReportSystem"]["ReportServerLag"],
...
APIDefs["C_ReportSystem.ReportStuckInCombat"] = {
    ...
    category = "general",
    subcategory = "c_reportsystem",
    func = _G["C_ReportSystem"] and _G["C_ReportSystem"]["ReportStuckInCombat"],
...
APIDefs["C_ReportSystem.TakeReportScreenshot"] = {
    ...
    category = "general",
    subcategory = "c_reportsystem",
    func = _G["C_ReportSystem"] and _G["C_ReportSystem"]["TakeReportScreenshot"],
