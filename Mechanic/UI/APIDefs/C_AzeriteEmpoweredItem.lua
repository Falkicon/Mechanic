...
APIDefs["C_AzeriteEmpoweredItem.GetAzeriteEmpoweredItemRespecCost"] = {
    ...
    category = "item",
    subcategory = "c_azeriteempowereditem",
    func = _G["C_AzeriteEmpoweredItem"] and _G["C_AzeriteEmpoweredItem"]["GetAzeriteEmpoweredItemRespecCost"],
...
APIDefs["C_AzeriteEmpoweredItem.IsHeartOfAzerothEquipped"] = {
    ...
    category = "item",
    subcategory = "c_azeriteempowereditem",
    func = _G["C_AzeriteEmpoweredItem"] and _G["C_AzeriteEmpoweredItem"]["IsHeartOfAzerothEquipped"],
