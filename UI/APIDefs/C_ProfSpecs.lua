...
APIDefs["C_ProfSpecs.GetDefaultSpecSkillLine"] = {
    ...
    category = "general",
    subcategory = "c_profspecs",
    func = _G["C_ProfSpecs"] and _G["C_ProfSpecs"]["GetDefaultSpecSkillLine"],
...
APIDefs["C_ProfSpecs.GetNewSpecReminderProfName"] = {
    ...
    category = "general",
    subcategory = "c_profspecs",
    func = _G["C_ProfSpecs"] and _G["C_ProfSpecs"]["GetNewSpecReminderProfName"],
...
APIDefs["C_ProfSpecs.GetSpecTabInfo"] = {
    ...
    category = "general",
    subcategory = "c_profspecs",
    func = _G["C_ProfSpecs"] and _G["C_ProfSpecs"]["GetSpecTabInfo"],
...
APIDefs["C_ProfSpecs.ShouldShowPointsReminder"] = {
    ...
    category = "general",
    subcategory = "c_profspecs",
    func = _G["C_ProfSpecs"] and _G["C_ProfSpecs"]["ShouldShowPointsReminder"],
...
APIDefs["C_ProfSpecs.ShouldShowSpecTab"] = {
    ...
    category = "general",
    subcategory = "c_profspecs",
    func = _G["C_ProfSpecs"] and _G["C_ProfSpecs"]["ShouldShowSpecTab"],
