...
APIDefs["C_LegendaryCrafting.CloseRuneforgeInteraction"] = {
    key = "C_LegendaryCrafting.CloseRuneforgeInteraction",
    name = "CloseRuneforgeInteraction",
    category = "profession",
    subcategory = "c_legendarycrafting",
    func = _G["C_LegendaryCrafting"] and _G["C_LegendaryCrafting"]["CloseRuneforgeInteraction"],
    funcPath = "C_LegendaryCrafting.CloseRuneforgeInteraction",
    params = {  },
    returns = {  },
...
APIDefs["C_LegendaryCrafting.GetRuneforgeItemPreviewInfo"] = {
    ...
    params = { { name = "baseItem", type = "ItemLocation", default = nil }, { name = "runeforgePowerID", type = "number", default = nil }, { name = "modifiers", type = "table", default = nil } },
...
APIDefs["C_LegendaryCrafting.GetRuneforgeLegendaryCraftSpellID"] = {
    key = "C_LegendaryCrafting.GetRuneforgeLegendaryCraftSpellID",
    name = "GetRuneforgeLegendaryCraftSpellID",
    category = "profession",
    subcategory = "c_legendarycrafting",
    func = _G["C_LegendaryCrafting"] and _G["C_LegendaryCrafting"]["GetRuneforgeLegendaryCraftSpellID"],
    funcPath = "C_LegendaryCrafting.GetRuneforgeLegendaryCraftSpellID",
    params = {  },
    returns = { { name = "spellID", type = "number", canBeSecret = false } },
    midnightImpact = "NORMAL",
}

APIDefs["C_LegendaryCrafting.GetRuneforgeLegendaryCurrencies"] = {
    key = "C_LegendaryCrafting.GetRuneforgeLegendaryCurrencies",
    name = "GetRuneforgeLegendaryCurrencies",
    category = "profession",
    subcategory = "c_legendarycrafting",
    func = _G["C_LegendaryCrafting"] and _G["C_LegendaryCrafting"]["GetRuneforgeLegendaryCurrencies"],
    funcPath = "C_LegendaryCrafting.GetRuneforgeLegendaryCurrencies",
    params = {  },
    returns = { { name = "currencies", type = "table", canBeSecret = false } },
    midnightImpact = "NORMAL",
}
...
APIDefs["C_LegendaryCrafting.GetRuneforgeLegendaryUpgradeCost"] = {
    ...
    params = { { name = "runeforgeLegendary", type = "ItemLocation", default = nil }, { name = "upgradeItem", type = "ItemLocation", default = nil } },
    returns = { { name = "cost", type = "table", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_LegendaryCrafting.GetRuneforgeModifierInfo"] = {
    ...
    params = { { name = "baseItem", type = "ItemLocation", default = nil }, { name = "powerID", type = "number", default = nil }, { name = "addedModifierIndex", type = "luaIndex", default = nil }, { name = "modifiers", type = "table", default = nil } },
    returns = { { name = "name", type = "string", canBeSecret = false }, { name = "description", type = "table", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
}

APIDefs["C_LegendaryCrafting.GetRuneforgeModifiers"] = {
    key = "C_LegendaryCrafting.GetRuneforgeModifiers",
    name = "GetRuneforgeModifiers",
    category = "profession",
    subcategory = "c_legendarycrafting",
    func = _G["C_LegendaryCrafting"] and _G["C_LegendaryCrafting"]["GetRuneforgeModifiers"],
    funcPath = "C_LegendaryCrafting.GetRuneforgeModifiers",
    params = {  },
    returns = { { name = "modifiedReagentItemIDs", type = "table", canBeSecret = false } },
    midnightImpact = "NORMAL",
}
...
APIDefs["C_LegendaryCrafting.GetRuneforgePowers"] = {
    ...
    params = { { name = "baseItem", type = "ItemLocation", default = nil }, { name = "filter", type = "RuneforgePowerFilter", default = nil } },
    returns = { { name = "primaryRuneforgePowerIDs", type = "table", canBeSecret = false }, { name = "otherRuneforgePowerIDs", type = "table", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
}
...
APIDefs["C_LegendaryCrafting.GetRuneforgePowersByClassSpecAndCovenant"] = {
    ...
    params = { { name = "classID", type = "number", default = nil }, { name = "specID", type = "number", default = nil }, { name = "covenantID", type = "number", default = nil }, { name = "filter", type = "RuneforgePowerFilter", default = nil } },
