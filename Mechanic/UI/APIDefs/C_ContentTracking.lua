...
APIDefs["C_ContentTracking.GetCollectableSourceTrackingEnabled"] = {
    ...
    category = "general",
    subcategory = "c_contenttracking",
    func = _G["C_ContentTracking"] and _G["C_ContentTracking"]["GetCollectableSourceTrackingEnabled"],
...
APIDefs["C_ContentTracking.GetCollectableSourceTypes"] = {
    ...
    category = "general",
    subcategory = "c_contenttracking",
    func = _G["C_ContentTracking"] and _G["C_ContentTracking"]["GetCollectableSourceTypes"],
