...
APIDefs["C_ContributionCollector.Close"] = {
    key = "C_ContributionCollector.Close",
    name = "Close",
    category = "general",
    subcategory = "c_contributioncollector",
    func = _G["C_ContributionCollector"] and _G["C_ContributionCollector"]["Close"],
    funcPath = "C_ContributionCollector.Close",
    params = {  },
    returns = {  },
...
APIDefs["C_ContributionCollector.GetActive"] = {
    key = "C_ContributionCollector.GetActive",
    name = "GetActive",
    category = "general",
    subcategory = "c_contributioncollector",
    func = _G["C_ContributionCollector"] and _G["C_ContributionCollector"]["GetActive"],
    funcPath = "C_ContributionCollector.GetActive",
    params = {  },
...
APIDefs["C_ContributionCollector.GetContributionAppearance"] = {
    ...
    params = { { name = "contributionID", type = "number", default = nil }, { name = "contributionState", type = "ContributionState", default = nil } },
...
APIDefs["C_ContributionCollector.GetRequiredContributionCurrency"] = {
    ...
    params = { { name = "contributionID", type = "number", default = nil } },
    returns = { { name = "currencyID", type = "number", canBeSecret = false }, { name = "currencyAmount", type = "number", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
}
...
APIDefs["C_ContributionCollector.GetRequiredContributionItem"] = {
    ...
    params = { { name = "contributionID", type = "number", default = nil } },
    returns = { { name = "itemID", type = "number", canBeSecret = false }, { name = "itemCount", type = "number", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
}
...
APIDefs["C_ContributionCollector.GetState"] = {
    ...
    params = { { name = "contributionID", type = "number", default = nil } },
    returns = { { name = "contributionState", type = "ContributionState", canBeSecret = false }, { name = "contributionPercentageComplete", type = "number", canBeSecret = false }, { name = "timeOfNextStateChange", type = "time_t", canBeSecret = false }, { name = "startTime", type = "time_t", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
}
