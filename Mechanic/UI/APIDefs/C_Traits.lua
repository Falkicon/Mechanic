...
APIDefs["C_Traits.CloseTraitSystemInteraction"] = {
    ...
    category = "general",
    subcategory = "c_traits",
    func = _G["C_Traits"] and _G["C_Traits"]["CloseTraitSystemInteraction"],
...
APIDefs["C_Traits.GetLoadoutSerializationVersion"] = {
    ...
    category = "general",
    subcategory = "c_traits",
    func = _G["C_Traits"] and _G["C_Traits"]["GetLoadoutSerializationVersion"],
...
APIDefs["C_Traits.HasValidInspectData"] = {
    ...
    category = "general",
    subcategory = "c_traits",
    func = _G["C_Traits"] and _G["C_Traits"]["HasValidInspectData"],
...
APIDefs["C_Traits.IsReadyForCommit"] = {
    ...
    category = "general",
    subcategory = "c_traits",
    func = _G["C_Traits"] and _G["C_Traits"]["IsReadyForCommit"],
...
APIDefs["C_Traits.TalentTestUnlearnSpells"] = {
    ...
    category = "general",
    subcategory = "c_traits",
    func = _G["C_Traits"] and _G["C_Traits"]["TalentTestUnlearnSpells"],
