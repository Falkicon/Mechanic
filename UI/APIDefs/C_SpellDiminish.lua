...
APIDefs["C_SpellDiminish.IsSystemSupported"] = {
    key = "C_SpellDiminish.IsSystemSupported",
    name = "IsSystemSupported",
    category = "spell",
    subcategory = "c_spelldiminish",
    func = _G["C_SpellDiminish"] and _G["C_SpellDiminish"]["IsSystemSupported"],
    funcPath = "C_SpellDiminish.IsSystemSupported",
    params = {  },
    returns = { { name = "isSystemSupported", type = "bool", canBeSecret = false } },
...
APIDefs["C_SpellDiminish.ShouldTrackSpellDiminishCategory"] = {
    ...
    params = { { name = "category", type = "SpellDiminishCategory", default = nil }, { name = "ruleset", type = "SpellDiminishRuleset", default = nil } },
